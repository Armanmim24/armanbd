...
package com.Update.Circle.ImageView;
...
public class UpdatedCircleImg extends ImageView {
    ...
    public UpdatedCircleImg(Context context) {
        super(context);

        init();
    }

    public UpdatedCircleImg(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UpdatedCircleImg(Context context, AttributeSet attrs, int defStyle) {
